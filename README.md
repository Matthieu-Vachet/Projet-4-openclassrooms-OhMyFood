...
<h1 align="center">Projet 4 OpenClassRooms OhMyFood</h1>

###

<h3 align="center">Améliorez l'interface d'un site mobile avec des animations CSS</h3>

###

<div align="center">
  <img height="200" src="https://zupimages.net/up/23/28/vnbh.png"  />
</div>
...
<p>📚 <strong>Action 3 :</strong> Intégrez la version mobile de la page d’accueil</p>
<p>📚 <strong>Action 4 :</strong> Ajoutez les animations à la page d’accueil</p>
<p>📚 <strong>Action 5 :</strong> Réalisez le responsive de la page d’accueil</p>
<p>📚 <strong>Action 6 :</strong> Intégrez le code d’une page de restaurant</p>
<p>📚 <strong>Action 7 :</strong> Copiez la page de restaurant et adaptez le contenu aux restaurants restants</p>
<p>📚 <strong>Action 8 :</strong>  Faites une revue complète du projet</p>
...
```bash
git clone https://github.com/Matthieu-Vachet/Projet-4-openclassrooms-OhMyFood.git
```
...
<h2 align="center">Project Link: https://github.com/Matthieu-Vachet/Projet-4-openclassrooms-OhMyFood.git </h2>
